...
const ProductDescription = () => {
    const { database, setModal } = useContext(StoreContext);
                        ...
                        <div className="product-page__data">
                            <div className="product-page__images">
                                <div
                                    ...
                                    style={{
                                        background: `transparent url(${productInfo.thumbnail.toString()}) no-repeat center`,
